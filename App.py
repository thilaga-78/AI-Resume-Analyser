...
# sql connector
connection = mysql.connector.connect(host='localhost',user='root',password='',db='cv')
...
def run():
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            ## Credentials 
            if ad_user == 'admin' and ad_password == 'admin_thilaga':
                ...
                st.success("Welcome Thilaga ! Total %d " % values + " User's Have Used Our Tool : )")                
